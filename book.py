...
class Buku(QMainWindow):
  ...
  def __init__(self):
    ...
    self.btnAddGenre.clicked.connect(self.tampilFormGenre)
    self.btnAddPenulis.clicked.connect(self.tampilFormPenulis)
